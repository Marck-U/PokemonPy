...
class Battle:
    ...
    def print_winner(self):
        if self.pokemon1.current_hp <= 0 < self.pokemon2.current_hp:
            print(self.pokemon2.name + " Tú pokemom " + str(self.actual_turn) + " turn")

        elif self.pokemon2.current_hp <= 0 < self.pokemon1.current_hp:
            print(self.pokemon1.name + " Tú pokemom " + str(self.actual_turn) + " turn")
        else:
            print("Double KO!!!!")

    def print_current_status(self):
        print(self.pokemon1.name + " tien " + str(self.pokemon1.current_hp)+ " left!")
        print(self.pokemon2.name + " tien " + str(self.pokemon2.current_hp)+ " left!")
